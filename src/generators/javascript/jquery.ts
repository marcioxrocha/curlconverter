import { Word, eq } from "../../shell/Word";
import { parse, getFirst, COMMON_SUPPORTED_ARGS } from "../../parse";
import type { Request, Warnings } from "../../parse";
...
export function _toJavaScriptJquery(
  ...
  let done = `.done(function( response, textStatus, request) {
