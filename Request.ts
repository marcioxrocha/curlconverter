import { Word, eq, mergeWords, joinWords } from "./shell/Word";

import { CCError, has, isInt } from "./utils";
import { warnf, warnIfPartsIgnored } from "./Warnings";
import type { Warnings, Support } from "./Warnings";
import type {
  GlobalConfig,
  OperationConfig,
  SrcDataParam,
...
import { Headers, parseCookies, parseCookiesStrict } from "./Headers";
import type { Cookies } from "./Headers";

import { pickAuth, type AuthType } from "./curl/auth";
export { AuthType } from "./curl/auth";

import { parseurl, type Curl_URL } from "./curl/url";

import { parseQueryString, percentEncodePlus } from "./Query";
import type { QueryList, QueryDict } from "./Query";

import { parseForm } from "./curl/form";
import type { FormParam } from "./curl/form";
